...
const CATALOGUE = [
  ...
  { name: 'Diff (Byrne Hobart)',        feedUrl: 'https://diff.substack.com/feed',                          tags: ['finance','technology','economics','business','markets','manufacturing','analysis','industry'] },
  { name: 'Tinkered Thinking',          feedUrl: 'https://tinkeredthinking.substack.com/feed',              tags: ['manufacturing','engineering','making','hardware','design','ideas','building'] },
  ...
  { name: 'Neckar\'s Industrials',     feedUrl: 'https://neckars.substack.com/feed',                       tags: ['investing','finance','manufacturing','industrials','analysis','stocks','industry'] },
