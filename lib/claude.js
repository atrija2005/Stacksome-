...
For each post, also include a "tldr" field: exactly 2 sentences. This is NOT a description or summary of what the article is about. It's the specific insight or mental shift the reader walks away with. Start sentence 1 with "You'll" or "This" or a strong verb. Make it concrete — name the actual idea, argument, or framework they'll gain. A reader should be able to decide in 3 seconds whether this is worth 20 minutes of their time.

Return ONLY a valid JSON array — no markdown, no code fences, no explanation:
[{"publication":"...","title":"...","url":"...","type":"core|adjacent|wild","why":"...","topic":"...","tldr":"..."}]`;
